...
def test_calculate_calls_summ():
    ...
    with patch('calc_mock.summ') as mock_summ:
...
def test_calculate_calls_subtract():
    ...
    with patch('calc_mock.subtract') as mock_subtract:
...
def test_calculate_calls_multiply():
    ...
    with patch('calc_mock.multiply') as mock_multiply:
...
def test_calculate_calls_err():
    ...
    with patch('calc_mock.err') as mock_err:
...
def test_calculate_invalid_choice():
    ...
    with patch('calc_mock.summ') as mock_summ, \
         patch('calc_mock.subtract') as mock_subtract, \
         patch('calc_mock.multiply') as mock_multiply, \
         patch('calc_mock.err') as mock_err:
